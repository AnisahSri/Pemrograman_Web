                  ...
                  <div class="owl-carousel owl-banner">
                      <div class="item item-1">
                          <div class="header-text">
                              <span class="category">Mata Dunia</span>
                              <h2>MEMBACA MERUPAKAN GUDANG ILMU</h2>
                              <p>Mata dunia terbuka lewat membaca, karena membaca adalah kunci menuju gudang ilmu.</p>
                              {{-- <div class="buttons">
